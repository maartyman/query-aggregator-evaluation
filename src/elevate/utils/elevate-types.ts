...
export class AthleteSettings {
  ...
  public static readonly DEFAULT_CYCLING_FTP: number | null = null;
  public static readonly DEFAULT_RUNNING_FTP: number | null = null;
  public static readonly DEFAULT_SWIM_FTP: number | null = null;
...
export abstract class AbstractAthlete {
...
export class Activity extends BareActivity {
  ...
  public static applySourceStats(activity: Activity, sourceStats: ActivityStats, stats: ActivityStats): void {
    ...
    activity.stats = Object.assign({}, stats, sourceStats);
  }
}
